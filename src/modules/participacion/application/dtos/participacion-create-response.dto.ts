...
export class ParticipacionCreateResponseDto {
  @ApiProperty()
  id: number;
  @ApiProperty()
  usuarioId: number;
  ...
  static fromEntity(e: ParticipacionEntity): ParticipacionCreateResponseDto {
    const dto = new ParticipacionCreateResponseDto();
    dto.id = e.id;
