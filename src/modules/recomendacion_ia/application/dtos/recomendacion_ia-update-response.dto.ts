...
export class RecomendacionIaUpdateResponseDto {
  @ApiProperty()
  id: number;
  ...
  static fromEntity(entity: Recomendacion_iaEntity): RecomendacionIaUpdateResponseDto {
    const dto = new RecomendacionIaUpdateResponseDto();
    dto.id = entity.id;
